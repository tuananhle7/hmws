                ...
                for include_symbols in "WRCP1234567890Ll"; do
                    for learn_eps in "--learn-eps"; do
                        for allow_repeat_factors in "--allow_repeat_factors" ""; do
                            ...
                            experiment_name=expt11_K${num_particles}_M${memory_size}_N${num_proposals_mws}_symbols${include_symbols}_lrc=${lr_prior_continuous}$learn_eps$allow_repeat_factors
