...
from cmws.examples.stacking_3d import data
...
def train(model, optimizer, stats, args):
    ...
    for iteration in range(
        ...
        if (
            ...
            stacking_3d_util.save_checkpoint(
    ...
    # work
    test_obs = data.generate_test_obs(device)

    # Normal training
    for iteration in range(num_iterations_so_far, args.num_iterations):
        # Generate data
        obs = data.generate_obs(args.batch_size, device)
